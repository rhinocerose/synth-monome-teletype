...
#define HELP_PAGES 17

// clang-format off

#define HELP1_LENGTH 71
const char* help1[HELP1_LENGTH] = { "1/17 HELP",
                                    "[ ] NAVIGATE HELP PAGES",
                                    "UP/DOWN TO SCROLL",
...
const char* help2[HELP2_LENGTH] = { "2/17 VARIABLES",
                                    " ",
...
const char* help4[HELP4_LENGTH] = { "4/17 DATA AND TABLES",
                                    " ",
                                    ...
                                    "EXP X|EXPO LOOKUP",
                                    "N 0-127|CONVERT SEMITONES",
                                    "    TO 1V/8VE",
                                    "VN X|CONVERT FROM 1V/8VE",
                                    "    TO SEMITONES",
                                    "// NOTE OPERATIONS",
                                    "SCALE NOTE OP - N.S",
                                    "HZ X|CONVERT FROM 1V/8VE",
                                    "    TO HZ/V",
                                    "N.S R S D",
                                    "    R = ROOT (0-127)",
                                    "    S = SCALE (0-8) *",
...
const char* help5[HELP5_LENGTH] = { "5/17 OPERATORS",
                                    ...
                                    "N.BX I D GET DEGREE IN SCALE I ",
                                    "N.BX I R B SET SCALE I ROOT and BITMASK",
                                    " ",
                                    "// EUCLIDEAN OPERATOR",
                                    "ER F L I",
                                    "   F = FILL (1-32)",
...
const char* help6[HELP6_LENGTH] = { "6/17 PRE :",
                                    " ",
                                    ...
                                    "DEL.B T B: |BITMASKED DELAY",
                                    "  T = TIME(MS) BETWEEN BITS",
                                    "  B = BITMASK DELAY PATTERN",
                                    "   16 BITS WHERE EACH BIT IS",
                                    "   AN ACTIVE DELAY TAP,",
                                    "   LSB = EXECUTED IMMEDIATELY",
                                    " ",
                                    "S: |PUSH ONTO STACK",
                                    "S.CLR|CLEAR S",
                                    "S.ALL|EXECUTE ALL S",
...
const char* help7[HELP7_LENGTH] = { "7/17 PATTERNS",
                                    " ",
                                    "// DIRECT ACCESS",
...
const char* help8[HELP8_LENGTH] = { "8/17 GRID",
                                    " ",
...
const char* help9[HELP9_LENGTH] = { "9/17 TURTLE",
                                    " ",
                                    "// CRAWLS TRACKER DATA",
                                    "@|GET/SET DATA",
...
const char* help10[HELP10_LENGTH] = { "10/17 MIDI IN",
                                      " ",
                                      "MI.$",
                                      "MI.$ x",
                                      "    GET OR SET SCRIPT",
                                      ...
                                      "    GET LATEST NOTE ON",
                                      "MI.LNV",
                                      "    GET LATEST NOTE ON SCALED",
                                      "MI.LV",
                                      "    GET LATEST VELOCITY",
                                      "MI.LVV",
                                      "    GET LATEST VELOCITY SCALED",
                                      "MI.LO",
                                      "    GET LATEST NOTE OFF",
                                      "MI.LC",
                                      "    GET LATEST CONTROLLER",
                                      "MI.LCC",
                                      "    GET LATEST CC VALUE",
                                      "MI.LCCV",
                                      "    GET LATEST CC SCALED",
                                      "MI.NL",
                                      "    GET NOTE ON COUNT",
                                      "MI.NCH",
                                      "    GET NOTE ON CHANNEL AT I",
                                      "MI.N",
                                      "    GET NOTE ON AT I",
                                      "MI.NV",
                                      "    GET NOTE ON AT I SCALED",
                                      "MI.V",
                                      "    GET VELOCITY AT I",
                                      "MI.VV",
                                      "    GET VELOCITY AT I SCALED",
                                      "MI.OL",
                                      "    GET NOTE OFF COUNT",
                                      "MI.OCH",
                                      "    GET NOTE OFF CHANNEL AT I",
                                      "MI.O",
                                      "    GET NOTE OFF AT I",
                                      "MI.CL",
                                      "    GET CC COUNT",
                                      ...
                                      "    GET CC VALUE AT I",
                                      "MI.CCV",
                                      "    GET CC VALUE AT I SCALED",
                                      "MI.CLKD",
                                      "MI.CLKD X",
                                      "    GET OR SET CLOCK DIVIDER ",
                                      "MI.CLKR",
                                      "    RESET CLOCK COUNTER" };

#define HELP11_LENGTH 39
const char* help11[HELP11_LENGTH] = { "11/17 GENERIC I2C",
                                      " ",
                                      "IIA",
                                      "    GET I2C ADDRESS",
                                      "IIA ADDRESS",
...
const char* help12[HELP12_LENGTH] = { "12/17 TELEX INPUT",
                                      " ",
                                      "TI.PARAM X|(TI.PRM)",
                                      "    GET KNOB VALUE",
                                      "TI.PARAM.QT X",
...
const char* help13[HELP13_LENGTH] = { "13/17 TELEX OUTPUT",
                                      " ",
                                      "TO.TR X Y",
                                      "    SET TR VALUE (0/1)",
                                      "TO.TR.TOG X",
...
const char* help14[HELP14_LENGTH] = { "14/17 ANSIBLE",
                                      " ",
                                      "ANS.G.LED X Y",
                                      "    READ GRID LED STATE",
                                      "    AT POS X, Y",
...
const char* help15[HELP15_LENGTH] = { "15/17 JUST FRIENDS & W/",
                                      " ",
                                      "JF.ADDR X",
                                      "    SETS JF II ADDRESS",
                                      "    1 = PRIMARY, 2 = SECONDARY",
                                      "    USE WITH ONLY 1 JF ON BUS",
                                      "    SAVES TO JF INTERNAL MEMORY",
                                      "JF.SEL X",
                                      "    SET TARGET JF UNIT",
                                      "    1 = PRIMARY, 2 = SECONDARY",
                                      "JF1: ...",
                                      ...
                                      "JF.SPEED",
                                      "JF.TSC",
                                      "    GET VALUE OF KNOB OR SWITCH",
                                      "JF.TR X Y",
                                      "    TRIGGER CHANNEL X (0 = ALL)",
                                      "    (1-6 = 1ST JF, 7-12 2ND JF)",
                                      "    (-1 = ALL CHANNELS BOTH JF)",
                                      ...
                                      "    X = PITCH, Y = VELOCITY",
                                      "JF.POLY X Y",
                                      "    AS JF.NOTE BUT NOTES ARE",
                                      "    ALLOCATED ACROSS BOTH JF,",
                                      "    SWAPPING EVERY 6TH NOTE",
                                      "JF.POLY.RESET",
...
const char* help16[HELP16_LENGTH] = { "16/17 DISTING EX",
                                      ...
                                      "    0 - INITIAL",
                                      "    1 - RECORDING",
                                      "    2 - RECORDING CROSSFADE",
                                      "    3 - PLAYBACK",
                                      "    4 - OVERDUB",
                                      "    5 - PAUSED/MUTED",
                                      "    6 - FADING OUT TO PAUSE",
                                      "EX.LP.REC X",
                                      "    TOGGLE RECORDING",
                                      "EX.LP.PLAY X",
                                      "    TOGGLE PLAYBACK",
                                      ...
                                      "EX.A1",
                                      "EX.A1 x",
                                      "    GET/SET LEFT DUAL ALGO",
                                      "EX.A2",
                                      "EX.A2 x",
                                      "    GET/SET RIGHT DUAL ALGO",
                                      "EX.A12 x y",
                                      "    SET BOTH DUAL ALGOS",
                                      "EX.P1 x",
                                      "EX.P1 x Y",
                                      ...
                                      "    GET/SET RIGHT PARAM",
                                      "EX.PV1 x y",
                                      "    SET LEFT PARAM SCALED",
                                      "EX.PV2 x y",
                                      "    SET RIGHT PARAM SCALED",
                                      "EX.MIN1 x",
                                      "    GET LEFT ALGO PARAM MIN",
                                      "EX.MIN2 x",
                                      "    GET RIGHT ALGO PARAM MIN",
                                      "EX.MAX1 x",
                                      "    GET LEFT ALGO PARAM MAX",
                                      "EX.MAX2 x",
                                      "    GET RIGHT ALGO PARAM MAX",
                                      "EX.Z1",
                                      "    GET LEFT Z KNOB (0..127)",
                                      "EX.Z1 x",
                                      "    SET LEFT Z PARAM (0..127)",
                                      "EX.ZO1",
                                      "    RESTORE LEFT Z CONTROL",
                                      "EX.Z2",
                                      "    GET RIGHT Z KNOB (0..127)",
                                      "EX.Z2 x",
                                      "    SET RIGHT Z PARAM (0..127)",
                                      "EX.ZO2",
                                      "    RESTORE RIGHT Z CONTROL",
                                      "EX.PRE1 x",
                                      "    LOAD LEFT PRESET",
                                      "EX.PRE2 x",
                                      "    LOAD RIGHT PRESET",
...
const char* help17[HELP17_LENGTH] = { "17/17 I2C2MIDI",
                                      ...
                                      "I2M.T x",
                                      "I2M.T# ch x",
                                      "    GET/SET NOTE DURATION (MS)",
                                      "I2M.SHIFT x",
                                      "I2M.S x",
                                      "I2M.S# ch x",
                                      "    GET/SET TRANSPOSITION",
                                      "I2M.MIN x y",
                                      "I2M.MIN# ch x y",
                                      "    SET MIN NOTE NUMBER",
                                      "I2M.MAX x y",
                                      ...
                                      "I2M.C.ADD x y",
                                      "I2M.C+ x y",
                                      "    ADD REL NOTE TO CHORD",
                                      "I2M.C.RM x y",
                                      "I2M.C- x y",
                                      "    REMOVE NOTE FROM CHORD",
                                      "I2M.C.INS x y z",
                                      "    INSERT NOTE IN CHORD",
                                      "I2M.C.DEL x y",
                                      "    DELETE NOTE FROM CHORD",
                                      "I2M.C.SET x y z",
                                      "    SET CHORD NOTE",
                                      "I2M.C.B x y",
                                      "    DEFINE CHORD USING BINARY",
                                      "I2M.C.CLR x",
                                      "    CLEAR CHORD",
                                      "I2M.C.L x y",
                                      "    GET/SET CHORD LENGTH",
                                      "I2M.C.SC x y",
                                      "    SET CHORD SCALE",
                                      "I2M.C.REV x y",
                                      "    SET CHORD REVERSAL",
                                      ...
                                      "    SET CHORD ROTATION",
                                      "I2M.C.TRP x y",
                                      "    SET CHORD TRANSPOSITION",
                                      "I2M.C.DIS x y z",
                                      "    SET CHORD DISTORTION",
                                      "I2M.C.REF x y z",
                                      "    SET CHORD REFLECTION",
                                      "I2M.C.INV x y",
                                      "    SET CHORD INVERSION",
                                      "I2M.C.STR x y",
                                      "    SET CHORD STRUMMING",
                                      "I2M.C.VCUR w x y z",
                                      "I2M.C.V~ w x y z",
                                      "    SET CHORD VELOCITY CURVE",
                                      "I2M.C.TCUR w x y z",
                                      "I2M.C.T~ w x y z",
                                      "    SET STRUMMING TIME CURVE",
                                      "I2M.C.DIR x y",
                                      "    SET PLAY DIRECTION",
                                      "I2M.C.QN x y z",
                                      "    GET TRANSFORMED NOTE",
                                      "I2M.C.QV x y z",
                                      "    GET TRANSFORMED VELOCITY",
                                      " ",
                                      "I2M.B.R x",
                                      "    BUFFER RECORDING ON/OFF",
                                      "I2M.B.L x",
                                      "    SET BUFFER LENGTH (MS)",
                                      "I2M.B.START x",
                                      "    ADD OFFSET TO BUFFER",
                                      "I2M.B.END x",
                                      "    ADD NEG OFFSET TO BUFFER",
                                      "I2M.B.DIR x",
                                      "    SET BUFFER PLAY DIRECTION",
                                      "I2M.B.SPE x",
                                      "    SET BUFFER PLAY SPEED",
                                      "I2M.B.FB x",
                                      "    SET FEEDBACK LENGTH",
                                      "I2M.B.NSHIFT x",
                                      "    SET BUFFER NOTE SHIFT",
                                      "I2M.B.VSHIFT x",
                                      "    SET BUFFER VELOCITY SHIFT",
                                      "I2M.B.TSHIFT x",
                                      "    SET BUFFER TIME SHIFT",
                                      "I2M.B.NOFF x",
                                      "    SET NOTE OFFSET",
                                      "I2M.B.VOFF x",
                                      "    SET VELOCITY OFFSET",
                                      ...
                                      "I2M.Q.CH x",
                                      "I2M.Q.# x",
                                      "    GET/SET MIDI QUERY CHANNEL",
                                      "I2M.Q.LATCH x",
                                      "    NOTE LATCHING ON/OFF",
                                      "I2M.Q.NOTE x",
                                      "I2M.Q.N x",
                                      "    GET RECEIVED NOTE",
                                      "I2M.Q.VEL x",
                                      "I2M.Q.V x",
                                      "    GET RECEIVED VELOCITY",
                                      "I2M.Q.CC x",
                                      "    GET RECEIVED CC",
                                      "I2M.Q.LCH",
                                      "    GET LATEST CHANNEL",
